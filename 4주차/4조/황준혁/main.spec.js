...
// describe, it, expect -> Jasmine 에서 제공하는 기본 함수
describe("로또 함수의", function() { // test 꾸러미
    describe("getRandomNum() 함수는", function() { // getRandomNum test
        it("1~45 사이에 랜덤한 수를 반환한다.", function() { // 함수의 특징 기능 test
            let rand_num = getRandomNum() // 상수
            /* 예측 & 기대 */
